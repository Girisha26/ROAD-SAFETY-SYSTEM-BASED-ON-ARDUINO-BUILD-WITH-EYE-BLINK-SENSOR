...
labels = os.listdir(r"E:\Project2k23\Driver Drowsiness\train")


def get_data(dir_path=r"E:\Project2k23\Driver Drowsiness\train", face_cas=r"E:\Project2k23\Driver Drowsiness\Required_files\haarcascade_frontalface_default.xml", eye_cas=r"E:\Project2k23\Driver Drowsiness\Required_files\haarcascade.xml"):
    labels = ['Closed', 'Open']
    IMG_SIZE = 145
    data = []
    for label in labels:
...
train_generator = train_generator.flow(
    np.array(X_train), y_train, shuffle=False)
