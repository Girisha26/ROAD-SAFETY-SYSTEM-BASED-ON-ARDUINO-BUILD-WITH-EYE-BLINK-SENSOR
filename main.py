...
classes = ['Closed', 'Open']
face_cascade = cv2.CascadeClassifier("E:/Project2k23/Driver Drowsiness/data/haarcascade_frontalface_default.xml")
left_eye_cascade = cv2.CascadeClassifier("E:/Project2k23/Driver Drowsiness/data/haarcascade_lefteye_2splits.xml")
right_eye_cascade = cv2.CascadeClassifier("E:/Project2k23/Driver Drowsiness/data/haarcascade_righteye_2splits.xml")
